    ...
    <Section
      ...
      <View style={{marginTop: 20}}>
        ...
        <TouchableX border onPress={() => {
          ...
          <View style={{padding: 16, flexDirection: 'row'}}>
            <IconX name={'build'} color={theme.colors.primary} size={20}></IconX>
        ...
        <TouchableX border onPress={() => {
          ...
          <View style={{padding: 16, flexDirection: 'row'}}>
            ...
            <IconX name={'card'} color={theme.colors.primary} size={20}></IconX>
        ...
        <TouchableX border onPress={() => {
          ...
          <View style={{padding: 16, flexDirection: 'row'}}>
            ...
            <IconX name={'accessibility'} color={theme.colors.primary} size={20}></IconX>
