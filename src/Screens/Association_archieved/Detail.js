            ...
            <View style={{flexDirection: 'column', marginTop: 5}}>
                ...
                <View style={{flexDirection: 'row', paddingTop: 5}}>
                    ...
                    <View style={{flex: 3}}>
                        ...
                        downloadFile(data.owner_passport)}}><IconX name={'md-eye'} color={theme.colors.background}></IconX></TouchableOpacity>
                    </View>
                </View>
                <View style={{flexDirection: 'row', paddingTop: 5}}>
                    ...
                    <View style={{flex: 3}}>
                        <TouchableOpacity style={{flex: 3, justifyContent: 'flex-start'}} onPress={() => {
                        downloadFile(data.title_deed)}}><IconX name={'md-eye'} color={theme.colors.background}></IconX></TouchableOpacity>
                    </View>
                </View>
                <View style={{flexDirection: 'row', paddingTop: 5}}>
                    ...
                    <View style={{flex: 3}}>
                        <TouchableOpacity style={{flex: 3, justifyContent: 'flex-start'}} onPress={() => {
                        downloadFile(data.contract)}}><IconX name={'md-eye'} color={theme.colors.background}></IconX></TouchableOpacity>
                    </View>
                </View>
                <View style={{flexDirection: 'row', paddingTop: 5}}>
                    ...
                    <View style={{flex: 3}}>
                        <TouchableOpacity style={{flex: 3, justifyContent: 'flex-start'}} onPress={() => {
                        downloadFile(data.tenants_passport)}}><IconX name={'md-eye'} color={theme.colors.background}></IconX></TouchableOpacity>
                    </View>
                </View>
                <View style={{flexDirection: 'row', paddingTop: 5}}>
                    ...
                    <View style={{flex: 3}}>
                        <TouchableOpacity style={{flex: 3, justifyContent: 'flex-start'}} onPress={() => {
                        downloadFile(data.tenants_visa)}}><IconX name={'md-eye'} color={theme.colors.background}></IconX></TouchableOpacity>
                    </View>
                </View>
                <View style={{flexDirection: 'row', paddingTop: 5}}>
                    ...
                    <View style={{flex: 3}}>
                        <TouchableOpacity style={{flex: 3, justifyContent: 'flex-start'}} onPress={() => {
                        downloadFile(data.tenants_emirates_id)}}><IconX name={'md-eye'} color={theme.colors.background}></IconX></TouchableOpacity>
                    </View>
                </View>
        ...
        return (
            <View style={{flexDirection: 'column', marginTop: 5}}>
                ...
                <View style={{flexDirection: 'row', paddingTop: 5}}>
                    ...
                    <View style={{flex: 3}}>
                        <TouchableOpacity style={{flex: 3, justifyContent: 'flex-start'}} onPress={() => {
                        downloadFile(data.trade_licence)}}><IconX name={'md-eye'} color={theme.colors.background}></IconX></TouchableOpacity>
                    </View>
                </View>
                {showRnderIssuesPanel()}
            </View>
