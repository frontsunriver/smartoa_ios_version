    ...
    <Section
      ...
      <View style={{marginTop: 20}}>
        <TouchableX border onPress={() => {
          ...
          <View style={{padding: 16, flexDirection: 'row'}}>
            <IconX name={'home'} color={theme.colors.primary} size={20}></IconX>
        ...
        <TouchableX border onPress={() => {
          ...
          <View style={{padding: 16, flexDirection: 'row'}}>
            <IconX name={'create'} color={theme.colors.primary} size={20}></IconX>
        ...
        <TouchableX border onPress={() => {
          ...
          <View style={{padding: 16, flexDirection: 'row'}}>
            <IconX name={'checkmark-done-outline'} color={theme.colors.primary} size={20}></IconX>
        ...
        <TouchableX border onPress={() => {
          ...
          <View style={{padding: 16, flexDirection: 'row'}}>
            <IconX name={'cloud-download'} color={theme.colors.primary} size={20}></IconX>
        ...
        <TouchableX border onPress={() => {
          ...
          <View style={{padding: 16, flexDirection: 'row'}}>
            <IconX name={'pencil'} color={theme.colors.primary} size={20}></IconX>
        ...
        <TouchableX border onPress={() => {
          ...
          <View style={{padding: 16, flexDirection: 'row'}}>
            <IconX name={'settings'} color={theme.colors.primary} size={20}></IconX>
      ...
      <View style={{position: "absolute", bottom: 50, left: 30, flexDirection: 'row'}}>
        <TouchableX border onPress={logout}>
          <View style={{padding: 16, flexDirection: 'row'}}>
            <IconX name={'key'} color={theme.colors.primary}></IconX>
            {/* <FontAwesome icon={keyIcon} style={{color: theme.colors.primary, fontSize: 20}} /> */}
            <Text style={{color: theme.colors.primary, marginLeft: 10}} size={20}>Logout</Text>
          </View>
        </TouchableX>
      </View>
    </Section>
