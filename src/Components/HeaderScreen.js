...
import FontAwesome, { parseIconFromClassName, SolidIcons, BrandIcons, RegularIcons } from 'react-native-fontawesome';
...
const HeaderScreen = (props) => {
    ...
    const leftIcon = parseIconFromClassName('fas angle-left')
    const homeIcon = parseIconFromClassName('fa fa-home');
      ...
      if (iconType == 'home') {
        return (
          <TouchableOpacity onPress={() => {
            ...
            <IconX name={'list-sharp'} color={theme.colors.primary}></IconX>
            {/* <FontAwesome icon={SolidIcons.bars} style={{color: theme.colors.primary, fontSize: 20}} /> */}
          </TouchableOpacity>
        )
      }else {
        ...
        return (
          <TouchableOpacity onPress={handleBack}>
            <IconX name={'chevron-back'} color={theme.colors.primary}></IconX>
            {/* <FontAwesome icon={SolidIcons.arrowLeft} style={{color: theme.colors.primary, fontSize: 20}} /> */}
          </TouchableOpacity>
        )
      }
    }
            ...
            <View style={{
              ...
              >
                ...
                <TouchableOpacity onPress={goHome}>
                  <IconX name={'home'} color={theme.colors.primary}></IconX>
