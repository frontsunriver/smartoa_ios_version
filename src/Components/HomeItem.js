        ...
        <View style={{flexDirection: 'column', flex: 1, alignItems: 'center', justifyContent: 'center'}}>
            ...
            <View style={{flexDirection: 'row', margin: 10, justifyContent: 'space-between'}}>
                <TouchableOpacity style={styles.touchableStyle} onPress={() => {
                    ...
                    <View style={{flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                        <IconX name={'build'} color={theme.colors.background} size={50}></IconX>
            ...
            <View style={{flexDirection: 'row', margin: 10, justifyContent: 'space-between'}}>
                <TouchableOpacity style={styles.touchableStyle} onPress={() => {
                    ...
                    <View style={{flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <IconX name={'card'} color={theme.colors.background} size={50}></IconX>
                ...
                <TouchableOpacity style={styles.touchableStyle} onPress={() => {
                    ...
                    <View style={{flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <IconX name={'accessibility'} color={theme.colors.background} size={50}></IconX>
